...
import com.app.nftcreatorappz.adapter.AdapterExported
...
import com.app.nftcreatorappz.databinding.FragmentExportedBinding
...
//                    Tools.openImage(requireContext(), obj)
    ...
    private fun onCreationLongTappedOverride(obj: String, pos: Int) {
        ...
        Tools.showDialog(
            activity,
            this.getString(R.string.delete_exp_tlt),
            this.getString(R.string.delete_exp_msg) + file.name + "?",
