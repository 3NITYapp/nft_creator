...
import com.app.nftcreatorappz.databinding.ActivityIntroBinding
...
class ActivityIntro : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.viewPagerActivityIntro.adapter = myViewPagerAdapter
        binding.viewPagerActivityIntro.addOnPageChangeListener(viewPagerPageChangeListener)
    ...
    private fun addBottomDots() {
        ...
        binding.layoutDotsActivityIntro.removeAllViews()
        for (i in dots.indices) {
            ...
            binding.layoutDotsActivityIntro.addView(dots[i])
        }
    }
